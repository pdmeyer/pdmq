...
,
					"patching_rect" : [ 69.0, 279.0, 53.0, 22.0 ],
					"text" : "p subdiv"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 153.0, 33.0, 22.0 ],
									"text" : "+~ 1"
								}
...
,
					"patching_rect" : [ 103.0, 252.0, 42.0, 22.0 ],
					"text" : "p map"
				}
...
,
					"patching_rect" : [ 69.0, 621.0, 113.0, 22.0 ],
					"text" : "gen~ @t swanramp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 390.0, 484.0, 76.0, 27.0 ],
					"range" : [ -0.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 171.0, 252.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-85",
					"ignoreclick" : 1,
					"jsarguments" : [ "algorithmic sequencing with queues" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 753.223876953125, 57.599853515625 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.0, 321.0, 95.0, 22.0 ],
					"text" : "prepend looplen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 646.0, 292.0, 66.0, 22.0 ],
					"text" : "listfunnel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 103.0, 191.0, 87.0, 22.0 ],
					"text" : "what~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 145.0, 230.0, 145.0, 22.0 ],
									"text" : "in 3 amplitude @default 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 287.0, 30.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 248.0, 3.0, 109.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 153.0, 3.0, 90.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 275.0, 130.0, 38.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 275.0, 31.0, 149.0, 22.0 ],
									"text" : "in 2 index-mod @default 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 3.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.0, 184.0, 73.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.0, 68.0, 46.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 230.0, 24.0, 22.0 ],
									"text" : "sin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 68.0, 57.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 115.0, 405.0, 57.0, 22.0 ],
									"text" : "out 1 PM"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.0, 486.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "int" ],
					"patching_rect" : [ 69.0, 312.0, 41.0, 22.0 ],
					"text" : "what~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 283.0, 81.0, 22.0 ],
					"text" : "s pdm_queue"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 313.0, 232.0, 136.0, 22.0 ],
					"text" : "route create"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 264.0, 111.0, 22.0 ],
					"text" : "name pdmq.ex.seq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 395.0, 156.0, 76.0, 27.0 ],
					"range" : [ -0.1, 1.1 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 423.0, 127.0, 40.0, 22.0 ],
									"text" : "* 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 191.0, 299.0, 22.0 ],
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 78.0, 44.0, 22.0 ],
									"text" : "history"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 51.0, 26.0, 22.0 ],
									"text" : "< 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 24.0, 35.0, 22.0 ],
									"text" : "delta"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 140.0, 26.0, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 237.0, 45.0, 22.0 ],
									"text" : "phasor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 286.0, 252.0, 66.0, 22.0 ],
									"text" : "buffer qbuf"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 286.0, 292.0, 86.0, 22.0 ],
									"text" : "buffer metabuf"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 143.0, 315.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 152.5, 277.703125, 119.6328125, 277.703125, 119.6328125, 14.0, 152.5, 14.0 ],
									"order" : 1,
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 69.0, 158.0, 311.0, 22.0 ],
					"text" : "gen~ @qbuf pdmq.ex.seq @metabuf pdmq.ex.seq_meta"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.0, 322.0, 67.0, 22.0 ],
					"text" : "write $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 215.0, 130.0, 66.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 287.0, 166.0, 115.0 ],
					"proportion" : 0.39,
					"saved_attribute_attributes" : 					{
						"bgfillcolor" : 						{
