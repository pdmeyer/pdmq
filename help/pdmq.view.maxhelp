...
,
					"patching_rect" : [ 56.0, 126.0, 50.0, 22.0 ],
					"text" : "p ?",
					"varname" : "q_tab"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 344.21600341796875, 57.599853515625 ]
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 100.0, 126.0, 650.0, 700.0 ],
						"openrect" : [ 0.0, 0.0, 650.0, 700.0 ],
						"gridsize" : [ 15.0, 15.0 ],
						"showontab" : 1,
						"integercoordinates" : 1,
						"boxes" : [ 							{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 582.0, 102.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 17.0, 220.0, 67.0, 22.0 ],
													"text" : "looplen 0 4"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 221.0, 115.0, 120.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 348.0, 166.0, 30.0, 22.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 93.0, 61.0, 115.0, 22.0 ],
													"text" : "t b clear"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 93.0, 220.0, 67.0, 22.0 ],
													"text" : "write $2 $1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 93.0, 192.0, 274.0, 22.0 ],
													"text" : "join"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 348.0, 142.0, 30.0, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 348.0, 115.0, 29.5, 22.0 ],
													"text" : "/ 8"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 93.0, 115.0, 59.0, 22.0 ],
													"text" : "random 8"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 93.0, 87.0, 274.0, 22.0 ],
													"text" : "uzi 32 0"
												}
...
,
					"patching_rect" : [ 30.0, 98.0, 47.0, 22.0 ],
					"text" : "p basic"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 385.928009033203125, 57.599853515625 ]
				}
...
, 			{
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-31" : [ "live.text[4]", "live.text", 0 ],
			"obj-1::obj-32" : [ "live.text[5]", "live.text", 0 ],
			"obj-1::obj-33" : [ "live.text[7]", "live.text", 0 ],
			"obj-1::obj-34" : [ "live.text[6]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
